...
public class MyAdapter extends BaseAdapter {
    ...
    public MyAdapter(Context context, ArrayList<String> na, ArrayList<String> pa) {
        names = na;
        paths = pa;
        directory = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_folder);
        file = BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_file);
