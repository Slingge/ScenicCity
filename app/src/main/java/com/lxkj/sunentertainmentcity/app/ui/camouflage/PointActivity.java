package com.lxkj.sunentertainmentcity.app.ui.camouflage;
...
public class PointActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        showFileDir(getExternalStorageDirectory().getPath());
    }
    /**
     * 扫描显示文件列表
     *
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //修改文件名
                    ...
                    LayoutInflater factory = LayoutInflater.from(PointActivity.this);
                    ...
                    AlertDialog renameDialog = new AlertDialog.Builder(PointActivity.this).create();
    ...
    private void displayToast(String message) {
        Toast.makeText(PointActivity.this, message, Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case Menu.FIRST + 1: {
                final EditText editText = new EditText(PointActivity.this);
                new AlertDialog.Builder(PointActivity.this).setTitle("请输入文件名称").setView(editText).setPositiveButton("确定",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                // TODO Auto-generated method stub
                                String mFileName = editText.getText().toString();
                                String IMAGES_PATH = getExternalStorageDirectory() + "/" + mFileName + "/";       //获取根目录
