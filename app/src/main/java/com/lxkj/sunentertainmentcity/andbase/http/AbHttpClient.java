 ...
 */
package com.lxkj.sunentertainmentcity.andbase.http;
...
import com.lxkj.sunentertainmentcity.andbase.cache.http.AbCacheHeaderParser;
import com.lxkj.sunentertainmentcity.andbase.cache.http.AbCacheResponse;
import com.lxkj.sunentertainmentcity.andbase.cache.http.AbCacheUtil;
import com.lxkj.sunentertainmentcity.andbase.cache.http.AbDiskBaseCache;
import com.lxkj.sunentertainmentcity.andbase.cache.http.AbDiskCache;
import com.lxkj.sunentertainmentcity.andbase.cache.http.AbHttpBaseCache;
import com.lxkj.sunentertainmentcity.andbase.global.AbAppConfig;
import com.lxkj.sunentertainmentcity.andbase.global.AbAppException;
import com.lxkj.sunentertainmentcity.andbase.http.entity.MultipartEntity;
import com.lxkj.sunentertainmentcity.andbase.http.entity.mine.content.StringBody;
import com.lxkj.sunentertainmentcity.andbase.http.ssl.EasySSLProtocolSocketFactory;
import com.lxkj.sunentertainmentcity.andbase.thread.AbThreadFactory;
import com.lxkj.sunentertainmentcity.andbase.util.AbAppUtil;
import com.lxkj.sunentertainmentcity.andbase.util.AbFileUtil;
    			...
    			try {
    				...
    				if(entry == null || entry.isExpired()){
    					...
    					if(response!=null){
    						...
    						AbDiskCache.Entry entryNew = AbCacheHeaderParser.parseCacheHeaders(response,cacheMaxAge);
    						if(entryNew!=null){
